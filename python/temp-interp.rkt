...
(define (temp-python-interp prog nexec table-inputs copy-table-inputs list-out)
  (if (equal? nexec 0)
  ...
  (let*
       ...
       (temp-python-interp prog ( - (length (car (hash-values table-inputs))) 1)  new-table copy-table-inputs new-list))))
